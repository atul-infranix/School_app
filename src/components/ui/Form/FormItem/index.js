...
const FormItem = React.forwardRef((props, ref) => {
    ...
    const enterStyleEnd = { opacity: 1, marginTop: 1, top: 0, right: 0 }
    const enterStyleBottom = { opacity: 1, marginTop: 3, bottom: -21 };
    const enterStyle = errorEnd ? enterStyleEnd : enterStyleBottom;
                ...
                <AnimatePresence exitBeforeEnter>
                    {invalid && (
                        <motion.div
                            ...
                            style={{ fontSize: errorFontSize ? errorFontSize : "13px" }}
                        >
                            {errorMessage}
                        </motion.div>
                    )}
